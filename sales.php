                     ...
                     $count=1;
                      ...
                      <tr>
                        ...
                        <td> <?php
                                                ...
                                                ?> </td>
                        <td>
                          <button class="btn btn-sm btn-primary dnkediti" data-id='<?php echo $arr['id']; ?>'><i
                              class="fas fa-eye"></i></button>
                          <button class="btn btn-sm btn-primary dnkeditid" data-id='<?php echo $arr['id']; ?>'
                            data-toggle="modal" data-target="#dnkModal1"><i class="fas fa-edit"></i></button>
                        </td>
